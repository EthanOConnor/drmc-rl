...
class DrMarioRetroEnv(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        if not self._using_backend:
            # Mock dynamics have no gameplay detection; consider the episode active immediately.
            self._in_game = True
    ...
    def step(self, action: int) -> Tuple[Any, float, bool, bool, Dict[str, Any]]:
        ...
        cleared = bool(self._viruses_remaining == 0 and not topout and self._in_game)
        if cleared:
