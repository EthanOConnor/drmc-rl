...
from seedlab.db import Attempt, CatalogDB, pack_actions
from seedlab.search import SearchEngine, SearchResult, beam_search, exact_search
...
class Explorer:
    ...
    def _run_rollouts(self, level: int, seed: int, k: int = 4) -> Tuple[int, Optional[SearchResult]]:
        ...
        from seedlab.search import _aux_infos
