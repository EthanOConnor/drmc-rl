...
Direct execution of submodules:
    python -m drmc_rl.training.ui.board_viewer
    python -m drmc_rl.training.ui.debug_viewer
    python -m drmc_rl.training.ui.tui
"""
from __future__ import annotations

# Core exports - always available
from .tui import RICH_AVAILABLE, TrainingMetrics, TrainingTUI


# Lazy imports for optional components to avoid circular import warnings
# when running submodules directly.
