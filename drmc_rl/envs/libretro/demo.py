"""Smoke test for DrMarioLibretroEnv with configurable emulator backend.

Usage:
    python -m drmc_rl.envs.libretro.demo --mode pixel --level 0 --steps 1000 --risk-tau 0.5 --backend libretro
"""
import argparse
...
def main():
    ...
    ap.add_argument(
        ...
        type=str,
        default=None,
        help="Emulator demo backend: libretro (default) or mock",
    )
    ...
    env = make("DrMarioLibretroEnv-v0", **env_kwargs)
