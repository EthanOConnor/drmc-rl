...
Loads seeds from drmc_rl/envs/libretro/seeds/registry.json and runs N episodes per seed,
computing E[T], Var[T], success %, and CVaR_α. Writes Parquet and CSV.

This script assumes your Gym env id is 'DrMarioLibretroEnv-v0' or that you have
...
def main():
    ...
    ap.add_argument('--registry', type=str, default='drmc_rl/envs/libretro/seeds/registry.json')
    ...
    try:
        from drmc_rl.eval.harness.seed_sweep_env_ctor import make_env as env_ctor
