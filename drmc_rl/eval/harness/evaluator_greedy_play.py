...
from drmc_rl.models.evaluator.runtime import ScriptEvaluator
from drmc_rl.models.policy.planning import plan_one_step
...
def main():
    ...
    register_env_id()
    env = make('DrMarioLibretroEnv-v0', obs_mode=args.obs_mode)
