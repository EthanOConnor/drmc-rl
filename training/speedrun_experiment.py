...
def main() -> None:
    ...
    def publish_frame(
        ...
        # Debug: print total steps calculation
        if slot.index == 0 and slot.frame_index % 60 == 0:  # Print every 60 frames for slot 0
            print(f"[DEBUG] total_steps={total_steps}, is_intermediate={is_intermediate}, current_total_steps={current_total_steps}, slot.episode_steps={slot.episode_steps}", flush=True)
